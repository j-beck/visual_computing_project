...
class QuadGraph
{
    ...
    int[] getBiggestCycle() {
        ...
        for(int[] p : cycles) {
            ...
            PVector v1 = intersection(l1,l2);
            PVector v2 = intersection(l2,l3);
            PVector v3 = intersection(l3,l4);
            PVector v4 = intersection(l4,l1);
            float area = getArea(v1,v2,v3,v4);
            if(area > maxArea) {
                maxArea = area;
                biggest = p ;
            }
                    ...
                    //  edge refers to our current node
                {
                        ...
                        //  cycle found
                    {
                        ...
                        if (isNew(p) && isNew(inv)) {
                            ...
                            if (isConvex(v1, v2, v3, v4)  && nonFlatQuad(v1, v2, v3, v4) ) {
                                cycles.add(p);
