      ...
      for (int y = 0; y <= 1; y++)
          ...
          //  edge refers to our current node
        {
            ...
            //  cycle found
          {
            ...
            {
				PVector v1 = new PVector(p[0], p[1]);
				PVector v2 = new PVector(p[1], p[2]);
				PVector v3 = new PVector(p[2], p[3]);
				PVector v4 = new PVector(p[3], p[0]);

				if (isConvex(v1, v2, v3, v4) && /*validArea(v1, v2, v3, v4, 1000, 60) &&*/ nonFlatQuad(v1, v2, v3, v4)) {
					cycles.add(p);
